        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <div class="text-muted mt-1">Approve pinjaman yang sudah direview pengurus</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <label class="form-label">Catatan Pengurus:</label>
                                <p class="text-muted small">{{ $pinjaman->catatan_pengurus }}</p>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="modal modal-blur fade" id="approveModal{{ $pinjaman->id }}" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <form action="{{ route('pinjaman.doApprove', $pinjaman) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        <p>Anda akan meng-approve pinjaman:</p>
                                        ...
                                        <p class="text-muted small">Pinjaman yang diapprove akan siap untuk dicairkan.</p>
                                        <div class="mb-3">
                                            <label class="form-label">Catatan (opsional)</label>
                                            <textarea name="catatan_bendahara" rows="3" class="form-control" placeholder="Catatan approval..."></textarea>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <form action="{{ route('pinjaman.doApprove', $pinjaman) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <p>Anda akan menolak pinjaman:</p>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="catatan_bendahara" rows="3" class="form-control" placeholder="Jelaskan alasan penolakan..." required></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn" data-bs-dismiss="modal">Batal</button>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body text-center py-5 text-muted">
                            ...
                            <div>Tidak ada pinjaman yang perlu di-approve</div>
                        </div>
                    </div>
                </div>
                @endforelse
